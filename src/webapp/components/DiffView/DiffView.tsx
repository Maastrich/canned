...
import DiffComputer, { DiffElement, DiffElementType, DiffMethod, LineInformations } from '../../compute/DiffComputer';
...
> {
        ...
        return (
          <span
            ...
            className={cn(this.styles.wordDiff, {
              [this.styles.wordAdded]: wordDiff.type === "added",
              [this.styles.wordRemoved]: wordDiff.type === "removed",
            })}>
  ...
  private renderSplitView = (
    { old: left, new: right }: LineInformations,
    index: number,
  ): JSX.Element => {
    return (
  ...
  private renderDiff = (): JSX.Element[] => {
    ...
    const { lineInfos: lineInformation } = computer;
    ...
    return lineInformation.map(
      (line: LineInformations, i: number): JSX.Element => {
